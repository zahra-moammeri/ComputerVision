...
from utils import (cells_to_bboxes, iou_width_height as iou, non_max_supression as nms, plot_image)

ImageFile.LOAD_TRUNCATED_IMAGES = True

class YOLODataset(Dataset):
    def __init__(self, csv_file, img_dir, label_dir, anchors, img_size= 416, 
...
def test():
    ...
    dataset = YOLODataset(csv_file, img_dir, label_dir, S = [13, 26, 52], anchors= anchors, transform= transform)
    S = [13, 26, 52]
